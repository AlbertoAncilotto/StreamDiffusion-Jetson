    ...
    while True:
        if not queue.empty():
            try:
                ...
                if element == '-1':
                    return
                output = postprocess_image(element, output_type="pil")[0]
...
def run(
    iterations: int = 10,
    model_id_or_path: str ="./vividWatercolors_10.safetensors",# "stabilityai/sd-turbo",#"KBlueLeaf/kohaku-v2.1", 
